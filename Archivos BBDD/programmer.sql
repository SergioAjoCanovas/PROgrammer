-- Creamos y seleccionamos la base de datos para evitar el error #1046
CREATE DATABASE IF NOT EXISTS programmer_db;
USE programmer_db;
...
-- Tabla de usuarios (AQUÍ AÑADIMOS LA FOTO DE PERFIL)
CREATE TABLE usuarios(
	id INT AUTO_INCREMENT PRIMARY KEY,
    username VARCHAR(30) NOT NULL UNIQUE,
    email VARCHAR(100) NOT NULL UNIQUE,
    password VARCHAR(255) NOT NULL,
    foto_perfil VARCHAR(255), -- <--- NUEVA COLUMNA PARA LA FOTO
...
-- Tabla de proyectos (AQUÍ AÑADIMOS LAS 4 FOTOS)
CREATE TABLE proyectos(
    ...
    foto_1 VARCHAR(255), -- <--- NUEVA COLUMNA FOTO 1
    foto_2 VARCHAR(255), -- <--- NUEVA COLUMNA FOTO 2
    foto_3 VARCHAR(255), -- <--- NUEVA COLUMNA FOTO 3
    foto_4 VARCHAR(255), -- <--- NUEVA COLUMNA FOTO 4
...
-- Insertar 3 Administradores con foto y contraseña encriptada
